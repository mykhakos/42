                                         ...
                                         int value)
{
    ...
    rot_variants[0] = get_rot_ops(rot_ops_all.ra, rot_ops_all.rb, 0, 0);
    rot_variants[1] = get_rot_ops(rot_ops_all.ra, 0, 0, rot_ops_all.rrb);
    rot_variants[2] = get_rot_ops(0, rot_ops_all.rb, rot_ops_all.rra, 0);
    rot_variants[3] = get_rot_ops(0, 0, rot_ops_all.rra, rot_ops_all.rrb);
    rot_variants[4] = NULL;
...
t_rot_ops *find_opt_rots_min_a_is_first(t_stack *stack_a)
{
    ...
    if (ra_count < rra_count)
        return get_rot_ops(0, 0, rra_count, 0);
    return get_rot_ops(ra_count, 0, 0, 0);
}