...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/21 17:59:37 by kmykhail          #+#    #+#             */
/*   Updated: 2023/09/21 18:20:27 by kmykhail         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_rot_ops	*find_opt_rots_push_value_to_a(t_stack *stack_a, t_stack *stack_b,
		int value)
{
...
t_rot_ops	*find_opt_rots_push_to_a(t_stack *stack_a, t_stack *stack_b)
{
	...
	{
		rots_temp = find_opt_rots_push_value_to_a(stack_a, stack_b,
				stack_b_ptr_cpy->value);
