...
/*   Updated: 2024/01/09 16:54:42 by kmykhail         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int						philo_init_and_set_phils_and_forks(t_philo *philo,
							int count);
...
void					phils_set_forks(t_phil *phils, t_fork *forks,
							int count);
void					phils_set_neighbors(t_phil *phils, int count);
void					phils_set_philo(t_phil *phils, t_philo *philo,
							int count);
void					phils_free(t_phil **phils, int count);
int						phil_is_allowed_to_eat(t_phil *phil);
void					phil_log(t_phil *phil, char *msg,
...
int						mutex_safeinit(pthread_mutex_t *mutex,
							void **free_on_error);
