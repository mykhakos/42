...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/09 16:45:05 by kmykhail          #+#    #+#             */
/*   Updated: 2024/01/09 16:45:13 by kmykhail         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/philo.h"

static void	phil_select_forks(t_phil *phil, pthread_mutex_t *fork_take_first,
...
static int	phil_take_forks(t_phil *phil, pthread_mutex_t *fork_take_first,
		pthread_mutex_t *fork_take_second)
{
